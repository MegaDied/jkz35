<?php
	include('functions/get_site_info.php');
			...
			if(!empty($_GET['email']) && !empty($_GET['hash'])){
				...
				$message= 'You account has been activated. You can login now. <br>You will be redirected in 5 seconds';
				header( "refresh:5;url=index.php" );
			}else{
				$message= "We could not activate this account. Possible reasons:<br>-Your account is already activated.<br>-Wrong has. Contact the administrator.<br>-Your e-mail is wrong.<br>-You try SQL injection which is impossible. Try harder next time ;)<br><br>Contact the administrator if your problem is not in the list.";
			}
		?>
