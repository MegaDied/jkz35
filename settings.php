...
<head>
    ...
    <title><?php echo $sitetitle; ?> - Profile Settings</title>
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="list-group">
                    <a href="settings.php" class="list-group-item active">Global Settings</a>
					<a href="settings/privacy.php" class="list-group-item">Privacy Settings</a>
                </div>
            </div>
            <!-- Content Column -->
            <div class="col-md-9">
                ...
                <h2>Global Settings</h2>
					...
					<?php
						while($row = $sql->fetch_assoc()){
							echo "<h4><b>Username: </b>" . $row['username'] . "</h6><br>";
							echo "<h4><b>E-mail: </b>" . $row['email'] . "</h6>";
						}
					?>	
            </div>
        </div>
